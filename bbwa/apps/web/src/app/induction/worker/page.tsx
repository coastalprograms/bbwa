...
export default function WorkerInductionPage() {
  ...
  async function onSubmit(values: FormData) {
    ...
    try {
      ...
      const workerData: Omit<Worker, 'id' | 'created_at' | 'induction_completed_at'> = {
        ...
        white_card: true, // Mandatory requirement - white card upload required
        other_license: values.otherLicense,
        other_license_details: values.otherLicenseDetails || null,
        ...
        // Site Rules Safety Checkboxes - CRITICAL: Save all safety compliance data
        no_alcohol_drugs: values.noAlcoholDrugs,
        electrical_equipment_responsibility: values.electricalEquipment,
        hazardous_substances_understanding: values.hazardousSubstances,
        use_ppe_when_necessary: values.usePPE,
        high_risk_work_meeting_understanding: values.highRiskWorkMeeting,
        appropriate_signage_display: values.appropriateSignage,
        no_unauthorized_visitors_understanding: values.noUnauthorizedVisitors,
        housekeeping_responsibility: values.housekeeping,
        // Employer Safety Requirements
        employer_provided_training: values.employerTraining,
        employer_provided_swms: values.employerSWMS,
        discussed_swms_with_employer: values.discussedSWMS,
        pre_start_meeting_understanding: values.preStartMeeting,
        // Safety Documentation
        read_safety_booklet: values.readSafetyBooklet,
        understand_site_management_plan: values.understandSMP,
        agree_safety: true, // All safety checkboxes must be checked to reach here
        agree_terms: true, // All safety checkboxes must be checked to reach here
